...
const ChildResourcesScreen = ({navigation, navScreen, setNavScreen, setSelectedCategory, setCurrScreen, currScreen, selectedCategory,nextScreen, childCarePlan, setChildCarePlan, mood, setIsMoodPicker, courtDate, courtTime, child, setNextScreen}) => {
  ...
  return (
    <View style={{flex: 1, width: '102%', height: '103%', left: -1, backgroundColor: "#85B0AE"}}>
        <TouchableOpacity style={[
                ...
                ]} onPress={() => setNavScreen("childExplore")}>
...
export default ChildResourcesScreen;
