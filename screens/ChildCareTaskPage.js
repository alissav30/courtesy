...
const ChildCareTasksScreen = ({ navigation, navScreen, setNavScreen, currScreen, setCurrScreen, mood, selectedCategory, setSelectedCategory, transportationPlan, setTransportationPlan, setIsMoodPicker, courtDate, courtTime, child }) => {
...
export default ChildCareTasksScreen;
